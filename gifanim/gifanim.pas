{
  ...
  ==================================================================================
  To allow the component to be used in more recent Lazarus versions some 
  Changes in datatypes has been performed. This code was tested in Lazarus 
...
uses
  Classes, LCLProc, Lresources, SysUtils, Types, Controls, Graphics, ExtCtrls,
